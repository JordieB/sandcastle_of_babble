...
class PDFToAudio:
    ...
    def generate_audio_files(self, start_page: Optional[int] = None, end_page: Optional[int] = None):
        """
        ...
        try:
            with open(self.pdf_path, 'rb') as pdf_file:
                ...
                # If start_page or end_page are not provided, default to the start and end of the PDF
